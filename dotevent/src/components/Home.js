			...
			<section className="heroSection">
				<Container>
					<Row>
						<Col md={6}>
							<h1>
								Find your next tech conference in the Polkadot
								ecosystem
							</h1>
							<p>
								Open-source and crowd-sourced list of<br></br>{" "}
								meetup around Polkadot ecosystem
							</p>
		...
		{hits.map((hit) => (
			...
			<Col md={12} key={hit.ObjectID}>
				...
				<div className="eventCard">
					...
					<button className="hashTag">Submit</button>
				</div>
			</Col>
		))}
	</div>
